...
import static com.practice.mihovil.myapplication.NewNoteActivity.getBytesFromBitmap;
...
public class UpdateNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            Integer noteId = extras.getInt("noteId");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.location:
                ...
                Intent openNoteIntent = new Intent(UpdateNoteActivity.this, MapsActivity.class);
                openNoteIntent.putExtra("noteId", id);
                openNoteIntent.putExtra("previous", "updateNote");
                startActivity(openNoteIntent);
                return true;
            case R.id.picture:
